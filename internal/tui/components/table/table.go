// Borrowed from https://github.com/charmbracelet/bubbles/blob/36baf3d64ee64d2768c65c516701493d9a271232/table/table.go
// Adds optimization to the StyleFunc implementation and fixes the selection override.
package table
